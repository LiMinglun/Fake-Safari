...
SWIFT_MODULE_NAMESPACE_PUSH("TiltedTabView")
@class NSCoder;

SWIFT_CLASS("_TtC13TiltedTabView29TiltedTabCollectionViewLayout")
@interface TiltedTabCollectionViewLayout : UICollectionViewLayout
...
SWIFT_CLASS("_TtC13TiltedTabView33TiltedTabGridCollectionViewLayout")
@interface TiltedTabGridCollectionViewLayout : TiltedTabCollectionViewLayout
- (void)prepareLayout;
...
SWIFT_CLASS("_TtC13TiltedTabView35TiltedTabTiltedCollectionViewLayout")
@interface TiltedTabTiltedCollectionViewLayout : TiltedTabCollectionViewLayout
- (void)prepareLayout;
@property (nonatomic, readonly) CGSize collectionViewContentSize;
- (UICollectionViewLayoutAttributes * _Nullable)layoutAttributesForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (NSArray<UICollectionViewLayoutAttributes *> * _Nullable)layoutAttributesForElementsInRect:(CGRect)rect SWIFT_WARN_UNUSED_RESULT;
...
- (UICollectionViewLayoutAttributes * _Nonnull)layoutAttributesForInteractivelyMovingItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath withTargetPosition:(CGPoint)position SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC13TiltedTabView17TiltedTabViewCell")
@interface TiltedTabViewCell : UICollectionViewCell
...
SWIFT_CLASS("_TtC13TiltedTabView23TiltedTabViewController")
@interface TiltedTabViewController : UICollectionViewController
...
@interface TiltedTabViewController (SWIFT_EXTENSION(TiltedTabView))
...
@interface TiltedTabViewController (SWIFT_EXTENSION(TiltedTabView)) <UIViewControllerTransitioningDelegate>
