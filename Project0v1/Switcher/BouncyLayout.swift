...
public class BouncyLayout: UICollectionViewFlowLayout {
    ...
    public var damping: CGFloat = BounceStyle.regular.damping
    public var frequency: CGFloat = BounceStyle.regular.frequency
    ...
    public lazy var animator: UIDynamicAnimator = UIDynamicAnimator(collectionViewLayout: self)
